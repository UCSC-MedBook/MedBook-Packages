...
var networkSchema = new SimpleSchema({
    "elements" : {
        ...
        new SimpleSchema([NetworkElements.simpleSchema(), {
            "position" : {
...
var patientReportSchema = new SimpleSchema({
    ...
    }, // refers to "patients" collection
    "patient_label" : {
        type : String
    }, // Patient_ID, ex. DTB-056
    ...
    "samples" : {
        type : [new SimpleSchema({
            ...
            "site_of_biopsy" : {
                type : String,
                optional : true
            }, // changed from site_of_metastasis
            "procedure_day" : {
                type : Number,
                optional : true
            },
...
var clinicalEvidenceSummariesSchema = new SimpleSchema({
    "gene" : {
        type : String,
        optional : true
    },
...
ClinicalEvidenceSummaries = new Meteor.Collection("ClinicalEvidenceSummaries");
ClinicalEvidenceSummaries.attachSchema(clinicalEvidenceSummariesSchema);
